...
import { Activity, Clock, Quote, Repeat } from "lucide-react";
...
const NeuralInsightsPanel = ({ activePath, nodes, edges, entries }: NeuralInsightsPanelProps) => {
